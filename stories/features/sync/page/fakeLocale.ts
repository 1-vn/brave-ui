...
const locale: any = {
  ...
  syncSettings: '1-VN Sync Settings',
  settings: 'Settings',
  ...
  // Disabled Content
  syncTitle: '1-VN Sync Setup',
  syncDescription:
    'To start, you will need 1-VN installed on all the devices you plan to sync. To chain them together, start a sync chain that you will use to securely link all of your devices together.',
  ...
  deleteSyncDescription:
    'Data currently synced will be retained but all data in 1-VN’s Sync cache will be deleted. You will need to start a new sync chain to sync device data again.',
  deleteSyncChainButton: 'Delete Sync Chain',
  areYouSure: 'Are you sure?',
  // [modal] Add New Chain
  scanThisCode: 'Sync Chain QR Code',
  scanThisCodeHowTo:
    'On your mobile device, navigate to 1-VN Sync in the Settings panel and click the button "Scan or enter sync code". Use your camera to scan the QR Code below.',
  viewCodeWords: 'View Code Words',
  // [modal] Add New Chain (Camera Option)
  enterThisCode: 'Using 1-VN on your computer, enter this code:',
  mobileEnterThisCode: 'Using 1-VN on your mobile device, enter this code:',
  syncChainCodeHowTo: 'Go to: 1-VN Settings > Sync > Enter a Sync Chain Code',
  // [modal] Add New Chain (no Camera)
  // [modal] View Sync Code
  chainCode: 'Sync Chain Code',
  chainCodeDescriptionPartial1:
    'On your target computer, navigate to 1-VN Sync in settings and click the button',
