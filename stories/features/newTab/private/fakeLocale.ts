...
const locale = {
  ...
  headerText: 'OneVN doesn’t remember what you do in a Private Window. Sites you visit won\'t show up in your history and cookies vanish when you’re done. Private Windows don’t make you completely anonymous online, though.',
  headerButton: 'Learn more',

  // Header Private Window with Tor
  headerTorTitle: 'Private Window with Tor',
  headerTorText: 'OneVN never remembers what you do in a Private Window. With Tor, your browsing is also hidden from your ISP or employer, and your IP address is hidden from the sites you visit.',
  headerTorButton: 'Learn more about Private Windows with Tor',

  // Box for DDG
  boxDdgLabel: 'Search Privately with',
  boxDdgTitle: 'DuckDuckGo',
  boxDdgText: 'With private search, OneVN will use DuckDuckGo for searches in Private Windows. DuckDuckGo doesn’t track your search history, so you can search privately.',
  ...
  boxTorText2: 'Using Private Tabs only changes what OneVN does on your device — it doesn\'t change anyone else\'s behavior. Tor hides your IP address from the sites you visit, and hides the sites you visit from your ISP or your employer. Open a Private Window with Tor from the menu, or with Alt+Shift+N or Option+Shift+N.',
  boxTorButton: 'Learn more about Tor in OneVN',

  // Modal Private Window with Tor
  modalPrivateWindowTorTitle: 'Link out to: https://support.1-vn.com/hc/en-us/articles/360018121491',

  // Modal Private Window
  modalPrivateWindowTitle: 'Link out to: https://support.1-vn.com/hc/en-us/articles/360017840332',

  // Modal Tor in OneVN
  modalTorInOneVNTitle: 'Link out to: https://support.1-vn.com/hc/en-us/articles/360018121491',
