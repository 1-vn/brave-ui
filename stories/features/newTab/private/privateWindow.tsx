      ...
      <Grid>
        <HeaderBox>
          <HeaderGrid>
            ...
            <div>
              ...
              <Text>{locale.headerText} <Link href='https://support.1-vn.com/hc/en-us/articles/360017840332' target='_blank'>{locale.headerButton}</Link></Text>
              {/* <FakeButton href='https://support.1-vn.com/hc/en-us/articles/360017840332' target='_blank'>
                {locale.headerButton}
              </FakeButton> */}
            </div>
          </HeaderGrid>
        ...
        <Box style={{ minHeight: '475px' }}>
          ...
          <ButtonGroup>
            ...
            <Link href='https://support.1-vn.com/hc/en-us/articles/360018266171' target='_blank'>{locale.learnMore}</Link>
          </ButtonGroup>
        </Box>
        <Box>
          <Content>
