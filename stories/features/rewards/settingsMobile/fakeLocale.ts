...
const locale = {
  adsDesc: 'Earn tokens by seeing ads on OneVN. Ads are matched from machine learning and the data temporarily present in your browser without tracking your information or sending it outside.',
  ...
  rewardsDisabledDescTwo: 'Today, OneVN welcomes you to the new internet. One where your time is valued, your personal data is kept private, and you actually get paid for your attention.',
  whyOneVNRewards: 'Why OneVN Rewards?'
}
