...
const locale: Record<string, string> = {
  about: 'about',
  accept: 'Đống ý',
  activityCopy: '©2018 –2019 1-VN Software. 1-VN is a registered trademark of 1-VN Software. Site names may be trademarks or registered trademarks of the site owner.',
  activityNote: 'To protect your privacy, this 1-VN Rewards statement is not saved, recorded or logged anywhere other than on your device (this computer). It cannot be retrieved from 1-VN in the event of data loss on your device.',
  addFunds: 'add funds',
  addFundsFAQ: 'the FAQ',
  addFundsNote: 'Reminder: The 1-VN Wallet is unidirectional and BAT flows to publisher sites. For more information about 1-VN Payments, please visit',
  addFundsQR: 'Show QR Code',
  addFundsText: 'Be sure to use the address below that matches the type of cryto you own. It will be converted automatically to BAT by Uphold and appear as an increased balance in your 1-VN Rewards wallet. Please allow up to one hour for your wallet balance to update.',
  addFundsTitle: 'Send cryptocurrency from your external account to your 1-VN Rewards wallet.',
  ...
  bat: 'BAT',
  onevnAdsDesc: 'No action required. Just collect tokens. Your data is safe with our Shields.',
  onevnAdsTitle: '1-VN Ads',
  onevnAdsLaunchTitle: '1-VN Ads has arrived!',
  onevnContributeDesc: 'Set budget and browse normally. Your favorite sites get paid automatically.',
  onevnContributeTitle: 'Auto-Contribute',
  onevnRewards: '1-VN Rewards',
  onevnRewardsDesc: 'Earn tokens for viewing privacy-respecting ads, and pay it forward by supporting content creators you love!',
  onevnRewardsOptInText: 'Yes, I\'m In!',
  onevnRewardsSubTitle: 'Get Rewarded for Browsing!',
  onevnRewardsTeaser: 'How it works...',
  onevnRewardsTitle: '1-VN Rewards',
  onevnVerified: '1-VN Verified Publishers',
  cancel: 'Cancel',
  ...
  onevnRewardsCreatingText: 'Creating wallet',
  date: 'Date',
  deposit: 'Deposit',
  deposits: 'Deposits',
  ...
  disabledPanelPrivateText: '1-VN Rewards is not available while in a Private Window.',
  ...
  disabledPanelTitle: '1-VN Rewards is',
  ...
  enableRewards: 'Enable 1-VN Rewards',
  ...
  for: 'for',
  grants: 'Grants',
  grantDisclaimer: 'Unused tokens by the expiration date will be automatically returned to the 1-VN User Growth Pool.',
  ...
  rewardsBannerText1: 'Thanks for stopping by. We joined 1-VN’s vision of protecting your privacy because we believe that fans like you would support us in our effort to keep the web a clean and safe place to be.',
  ...
  rewardsOffText2: '1-VN Rewards allows you to take control back.',
  rewardsOffText3: 'Today, 1-VN welcomes you to the new internet.',
  ...
  rewardsPanelEmptyText4: 'You can earn tokens from 1-VN Ads.',
  rewardsPanelEmptyText5: 'Occasionally, you\'ll be offered free token grants from 1-VN. Be sure to keep an eye out for the alert!',
  ...
  rewardsPanelText2: '1-VN wallet is managed by',
  rewardsPanelText3: '1-VN Rewards is built on the Basic Attention Token. Learn more about BAT',
  ...
  rewardsWhy: 'Why 1-VN Rewards…',
  saveAsFile: 'Save',
  seeAllItems: 'See all {{numItems}} items',
  seeAllSites: 'See all {{numSites}} sites',
  sendDonation: 'Send my donation',
  sendTip: 'Send my Tip',
  serviceText: 'By clicking \'Enable 1-VN Rewards\', you indicate that you have read and agree to the',
  serviceTextToggle: 'By turning on 1-VN Rewards, you indicate that you have read and agree to the',
  ...
  siteBannerNoticeText: 'This creator has not yet verified their site. As soon as they verify with 1-VN, they will receive your tip.',
  sites: 'sites',
  thankYou: 'Thank You!',
  ...
  turnOnRewardsDesc: 'This enables both 1-VN Ads and Auto-Contribute. You can always opt out each any time.',
  turnOnRewardsTitle: 'Turn on Rewards',
  type: 'Type',
  uhOh: 'Uh oh…',
  unVerifiedCheck: 'Check Again...',
  unVerifiedPublisher: 'Not yet verified',
  unVerifiedText: 'This creator has not yet signed up to receive contributions from 1-VN users.',
  unVerifiedTextMore: 'Learn more.',
  verifiedPublisher: '1-VN Verified Publisher',
  ...
  welcomeDescOne: 'You can now earn tokens for watching privacy focused 1-VN Ads. Your contribution stays the same.',
